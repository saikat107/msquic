...
our %config = (
    ...
    "perlargv" => [
        ...
        "--libdir=lib",
        "--openssldir=/usr/lib/ssl",
        "--prefix=/home/runner/work/msquic/msquic/build_cov/_deps/opensslquic-build/quictls"
    ],
    "perlenv" => {
        "AR" => undef,
        "ARFLAGS" => undef,
